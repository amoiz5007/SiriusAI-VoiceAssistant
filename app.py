...
WEATHER_API_KEY = "6b71541c7e75444e8d352656252201"
...
def process_command(command):
    ...
    if "play number guessing game" in command or "anumber guessing game" in command:
    ...
    elif "our sir" in command or "our teacher" in command:
        return "Best Teachers of Software Department, Love You So Much!"
        ...
        return "Thanks to our instructors for guiding us!, Allahafiz."
...
def start_number_guessing_game():
    ...
    return "I have chosen a number between 1 and 100. Start guessing!"
